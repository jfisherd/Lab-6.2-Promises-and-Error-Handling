...
<br>Errors handled separately will call their individual catch statements.

<br>

> How does using custom error classes improve debugging and error identification?
<br>Custom errors can have their error messages specialized to the conditions that result in a thrown error. 

<br>

> When might a retry mechanism be more effective than an immediate failure response?
<br>Anytime a system is waiting to receive information, otherwise an unexpected delay would guarantee no result.
<br>
